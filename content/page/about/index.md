...
<nav class="about-nav" aria-label="Page sections"><a href="#focus">What I explore</a><a href="#site">About this site</a><a href="#future">What is next</a><a href="#contact">Find me</a></nav>
...
<section id="future" class="about-section"><h2 class="about-heading">What is next</h2><p>I will improve the site module by module: first the personal introduction and public links, then the launchpad, photo wall, demo articles, and taxonomies. Small steps make the site easier to maintain and make the Hugo and GitHub workflow easier to learn.</p></section>
